...
class SaveTagsCommand(Command):
    name = "elk-save-tags"
    description = "Save packaging tags for the current system to a file"

    arguments = [
        argument("output", "Output file path for the tags"),
    ]
    ...
    def handle(self) -> int:
        ...
        with open(output_path, "w") as f:
            ...
            f.write(f"# Generated by: poetry elk-save-tags\n")
            f.write(f"#\n")
            f.write(f"# To regenerate, run on the target machine:\n")
            f.write(f"#   poetry elk-save-tags {output_path}\n")
